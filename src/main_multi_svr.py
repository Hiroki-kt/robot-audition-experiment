...
if __name__ == '__main__':
    ...
    data_set_file_path = onedrive_path + '_array/200229/'
    model_file1 = onedrive_path + '_array/200229/svr_191015_PTs01_mic_combine_4_ver2.pkl'
    model_file2 = onedrive_path + '_array/200229/svr_191015_STs01_mic_combine_4.pkl'

    data_name1 = '191015_PTs01_mic_combine_1'
    data_name2 = '191015_STs01_mic_combine_1'
    ...
    es1 = ExecuteSVR(data_set_file1, not_auto=True, label_max=45, label_min=-45, output_file_name=output_file)
